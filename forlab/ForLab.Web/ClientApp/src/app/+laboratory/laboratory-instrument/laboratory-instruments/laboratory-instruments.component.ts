...
import { LaboratoryInstrumentDto, LaboratoryInstrumentFilterDto } from 'src/@core/models/laboratory/LaboratoryInstrument';
...
import { AddEditLaboratoryInstrumentComponent } from '../add-edit-laboratory-instrument/add-edit-laboratory-instrument.component';
...
@Component({
  selector: 'app-laboratory-instruments',
  templateUrl: './laboratory-instruments.component.html',
  styleUrls: ['./laboratory-instruments.component.scss']
})
export class LaboratoryInstrumentsComponent extends BaseService implements OnInit {
  ...
  filterDto: LaboratoryInstrumentFilterDto = new LaboratoryInstrumentFilterDto();
  ...
  columns: TableColumn<LaboratoryInstrumentDto>[] = [
    ...
    { label: 'Quantity', property: 'quantity', type: 'int', visible: true },
    { label: 'Test Run Percentage', property: 'testRunPercentage', type: 'percent', visible: true },
  ...
  loadData() {
    ...
    let params: QueryParamsDto[] = [
      ...
      // Filter
      { key: 'laboratoryName', value: this.searchInput.nativeElement.value },
    ];

    // Append FilterDto values to the paramaters
    params = params.concat(this.getFilterParamsDtos(this.filterDto));

    this.dataSource.loadObjects(LaboratoryInstrumentsController.GetAll, params);
  }
  ...
  createObject() {
    this.dialog.open(AddEditLaboratoryInstrumentComponent, {
      data: {
        laboratoryId: this.laboratoryId,
        fromLaboratoryDetails: this.fromLaboratoryDetails,
        laboratoryInstrumentDto: new LaboratoryInstrumentDto()
      }
    })
      .afterClosed()
  ...
  updateObject(laboratoryInstrument: LaboratoryInstrumentDto) {
    this.dialog.open(AddEditLaboratoryInstrumentComponent, {
      data: {
        laboratoryId: this.laboratoryId,
        fromLaboratoryDetails: this.fromLaboratoryDetails,
        laboratoryInstrumentDto: laboratoryInstrument
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  updateIsActive(laboratoryInstrument: LaboratoryInstrumentDto) {
    this.dialog.open(ConfirmActiveComponent, {
      data: {
        url: LaboratoryInstrumentsController.UpdateIsActive,
        objectInfo: [{ key: 'Laboratory', value: laboratoryInstrument.laboratoryName }, { key: 'Instrument', value: laboratoryInstrument.instrumentName }],
        isActive: !laboratoryInstrument.isActive,
        queryParamsDto: { key: 'laboratoryInstrumentId', value: laboratoryInstrument.id },
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  deleteObject(laboratoryInstrument: LaboratoryInstrumentDto) {
    this.dialog.open(ConfirmDeleteComponent, {
      data: {
        url: LaboratoryInstrumentsController.RemoveLaboratoryInstrument,
        objectInfo: [{ key: 'Laboratory', value: laboratoryInstrument.laboratoryName }, { key: 'Instrument', value: laboratoryInstrument.instrumentName }],
        queryParamsDto: { key: 'laboratoryInstrumentId', value: laboratoryInstrument.id },
      }
    })
  ...
  export() {
    ...
    this.dialog.open(ConfirmExportComponent, {
      data: {
        url: LaboratoryInstrumentsController.ExportLaboratoryInstruments,
        fileName: 'LaboratoryInstruments',
