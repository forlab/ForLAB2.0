...
import { LaboratoryConsumptionDto, LaboratoryConsumptionFilterDto } from 'src/@core/models/laboratory/LaboratoryConsumption';
...
import { AddEditLaboratoryConsumptionComponent } from '../add-edit-laboratory-consumption/add-edit-laboratory-consumption.component';
...
@Component({
  selector: 'app-laboratory-consumptions',
  templateUrl: './laboratory-consumptions.component.html',
  styleUrls: ['./laboratory-consumptions.component.scss']
})
export class LaboratoryConsumptionsComponent extends BaseService implements OnInit {
  ...
  filterDto: LaboratoryConsumptionFilterDto = new LaboratoryConsumptionFilterDto();
  ...
  columns: TableColumn<LaboratoryConsumptionDto>[] = [
    ...
    { label: 'Duration', property: 'consumptionDuration', type: 'date', visible: true },
    { label: 'Amount Used', property: 'amountUsed', type: 'number', visible: true },
  ...
  loadData() {
    ...
    let params: QueryParamsDto[] = [
      ...
      // Filter
      { key: 'amountUsed', value: this.searchInput.nativeElement.value || this.filterDto.amountUsed },
    ];

    // Append FilterDto values to the paramaters
    params = params.concat(this.getFilterParamsDtos(this.filterDto));

    this.dataSource.loadObjects(LaboratoryConsumptionsController.GetAll, params);
  }
  ...
  createObject() {
    this.dialog.open(AddEditLaboratoryConsumptionComponent, {
      data: {
        laboratoryId: this.laboratoryId,
        fromLaboratoryDetails: this.fromLaboratoryDetails,
        laboratoryConsumptionDto: new LaboratoryConsumptionDto()
      }
    })
      .afterClosed()
  ...
  updateObject(laboratoryConsumption: LaboratoryConsumptionDto) {
    this.dialog.open(AddEditLaboratoryConsumptionComponent, {
      data: {
        laboratoryId: this.laboratoryId,
        fromLaboratoryDetails: this.fromLaboratoryDetails,
        laboratoryConsumptionDto: laboratoryConsumption
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  updateIsActive(laboratoryConsumption: LaboratoryConsumptionDto) {
    this.dialog.open(ConfirmActiveComponent, {
      data: {
        url: LaboratoryConsumptionsController.UpdateIsActive,
        objectInfo: [{ key: 'Laboratory', value: laboratoryConsumption.laboratoryName }, { key: 'Product', value: laboratoryConsumption.productName }],
        isActive: !laboratoryConsumption.isActive,
        queryParamsDto: { key: 'laboratoryConsumptionId', value: laboratoryConsumption.id },
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  deleteObject(laboratoryConsumption: LaboratoryConsumptionDto) {
    this.dialog.open(ConfirmDeleteComponent, {
      data: {
        url: LaboratoryConsumptionsController.RemoveLaboratoryConsumption,
        objectInfo: [{ key: 'Laboratory', value: laboratoryConsumption.laboratoryName }, { key: 'Product', value: laboratoryConsumption.productName }],
        queryParamsDto: { key: 'laboratoryConsumptionId', value: laboratoryConsumption.id },
      }
    })
  ...
  export() {
    ...
    this.dialog.open(ConfirmExportComponent, {
      data: {
        url: LaboratoryConsumptionsController.ExportLaboratoryConsumptions,
        fileName: 'LaboratoryConsumptions',
