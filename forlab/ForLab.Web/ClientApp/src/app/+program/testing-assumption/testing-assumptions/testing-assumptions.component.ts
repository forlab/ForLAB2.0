...
import { AddEditTestingAssumptionComponent } from '../add-edit-testing-assumption/add-edit-testing-assumption.component';
...
import { TestingAssumptionParameterFilterDto, TestingAssumptionParameterDto } from 'src/@core/models/program/TestingAssumptionParameter';
import { TestingAssumptionParametersController } from 'src/@core/APIs/TestingAssumptionParametersController';

@Component({
  selector: 'testing-assumptions',
  templateUrl: './testing-assumptions.component.html',
  styleUrls: ['./testing-assumptions.component.scss']
})
export class TestingAssumptionsComponent extends BaseService implements OnInit {
  ...
  filterDto: TestingAssumptionParameterFilterDto = new TestingAssumptionParameterFilterDto();

  // Table
  @ViewChild(MatPaginator, { static: false }) paginator: MatPaginator;
  @ViewChild(MatSort, { static: false }) sort: MatSort;
  @ViewChild('searchInput', { static: false }) searchInput: ElementRef;
  columns: TableColumn<TestingAssumptionParameterDto>[] = [
  ...
  selection = new SelectionModel<TestingAssumptionParameterDto>(true, []);
  ...
  loadData() {
    ...
    this.dataSource.loadObjects(TestingAssumptionParametersController.GetAll, params);
  }
  ...
  createObject() {
    this.dialog.open(AddEditTestingAssumptionComponent, {
      data: {
        programId: this.programId,
        fromProgramDetails: this.fromProgramDetails,
        testingAssumptionParameterDto: new TestingAssumptionParameterDto()
      }
    })
      .afterClosed()
  ...
  updateObject(testingAssumptionParameter: TestingAssumptionParameterDto) {
    this.dialog.open(AddEditTestingAssumptionComponent, {
      data: {
        programId: this.programId,
        fromProgramDetails: this.fromProgramDetails,
        testingAssumptionParameterDto: testingAssumptionParameter
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  updateIsActive(testingAssumptionParameter: TestingAssumptionParameterDto) {
    this.dialog.open(ConfirmActiveComponent, {
      data: {
        url: TestingAssumptionParametersController.UpdateIsActive,
        objectInfo: [{ key: 'Program', value: testingAssumptionParameter.programName }, { key: 'Name', value: testingAssumptionParameter.name }],
        isActive: !testingAssumptionParameter.isActive,
        queryParamsDto: { key: 'testingAssumptionParameterId', value: testingAssumptionParameter.id },
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  deleteObject(testingAssumptionParameter: TestingAssumptionParameterDto) {
    this.dialog.open(ConfirmDeleteComponent, {
      data: {
        url: TestingAssumptionParametersController.RemoveTestingAssumptionParameter,
        objectInfo: [{ key: 'Program', value: testingAssumptionParameter.programName }, { key: 'Name', value: testingAssumptionParameter.name }],
        queryParamsDto: { key: 'testingAssumptionParameterId', value: testingAssumptionParameter.id },
      }
    })
  ...
  export() {
    ...
    this.dialog.open(ConfirmExportComponent, {
      data: {
        url: TestingAssumptionParametersController.ExportTestingAssumptionParameters,
        fileName: 'TestingAssumptionParameters',
