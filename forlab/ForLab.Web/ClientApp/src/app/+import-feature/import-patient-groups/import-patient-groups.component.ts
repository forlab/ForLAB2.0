...
@Component({
  selector: 'import-patient-groups',
  templateUrl: './import-patient-groups.component.html',
  styleUrls: ['./import-patient-groups.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ImportPatientGroupsComponent extends BaseService implements OnInit {

  // Table
  @Input('data') data: PatientGroupDto[] = [];
  ...
  submit() {
    ...
    this.loading = true;
    let objectDtos: PatientGroupDto[] = [];
    ...
    this.httpService.POST(PatientGroupsController.ImportPatientGroups, objectDtos)
