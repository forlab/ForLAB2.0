...
@Component({
  selector: 'import-testing-assumption-parameters',
  templateUrl: './import-testing-assumption-parameters.component.html',
  styleUrls: ['./import-testing-assumption-parameters.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ImportTestingAssumptionParametersComponent extends BaseService implements OnInit {
  @Input('fromCreatingProgram') fromCreatingProgram: boolean = false;
  // Drp
  programs: ProgramDto[] = [];
  // Table
  @Input('data') data: TestingAssumptionParameterDto[] = [];
  ...
  submit() {
    ...
    this.loading = true;
    let objectDtos: TestingAssumptionParameterDto[] = [];
    ...
    this.httpService.POST(TestingAssumptionParametersController.ImportTestingAssumptionParameters, objectDtos)
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe(res => {
