...
@Component({
  selector: 'import-product-assumption-parameters',
  templateUrl: './import-product-assumption-parameters.component.html',
  styleUrls: ['./import-product-assumption-parameters.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ImportProductAssumptionParametersComponent extends BaseService implements OnInit {
  @Input('fromCreatingProgram') fromCreatingProgram: boolean = false;
  // Drp
  programs: ProgramDto[] = [];
  // Table
  @Input('data') data: ProductAssumptionParameterDto[] = [];
  ...
  submit() {
    ...
    this.loading = true;
    let objectDtos: ProductAssumptionParameterDto[] = [];
    ...
    this.httpService.POST(ProductAssumptionParametersController.ImportProductAssumptionParameters, objectDtos)
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe(res => {
