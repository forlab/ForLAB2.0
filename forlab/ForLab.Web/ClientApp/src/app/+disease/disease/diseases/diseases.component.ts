...
import { DiseaseDto, DiseaseFilterDto } from 'src/@core/models/disease/Disease';
...
import { AddEditDiseaseComponent } from '../add-edit-disease/add-edit-disease.component';
...
export class DiseasesComponent extends BaseService implements OnInit {

  filterDto: DiseaseFilterDto = new DiseaseFilterDto();
  ...
  loadData() {
    ...
    this.dataSource.loadObjects(DiseasesController.GetAll, params);
  }
  ...
  createObject() {
    this.dialog.open(AddEditDiseaseComponent)
      .afterClosed()
  ...
  updateObject(disease: DiseaseDto) {
    this.dialog.open(AddEditDiseaseComponent, {
      data: disease
    })
      .afterClosed()
  ...
  updateIsActive(disease: DiseaseDto) {
    this.dialog.open(ConfirmActiveComponent, {
      data: {
        url: DiseasesController.UpdateIsActive,
        objectInfo: [{ key: 'Disease', value: disease.name }],
        isActive: !disease.isActive,
        queryParamsDto: { key: 'diseaseId', value: disease.id },
      }
    })
      .afterClosed()
      .pipe(takeUntil(this.ngUnsubscribe))
  ...
  deleteObject(disease: DiseaseDto) {
    this.dialog.open(ConfirmDeleteComponent, {
      data: {
        url: DiseasesController.RemoveDisease,
        objectInfo: [{ key: 'Disease', value: disease.name }],
        queryParamsDto: { key: 'diseaseId', value: disease.id },
      }
    })
  ...
  export() {
    ...
    this.dialog.open(ConfirmExportComponent, {
      data: {
        url: DiseasesController.ExportDiseases,
        fileName: 'Diseases',
  ...
  changeIsActiveForSelected(isActive: boolean) {
    ...
    this.dialog.open(ConfirmActiveSelectedComponent, {
      data: {
        url: DiseasesController.UpdateIsActiveForSelected,
