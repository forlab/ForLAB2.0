...
@Component({
  selector: 'app-servicestatisticdatausage3',
  templateUrl: './servicestatisticdatausage3.component.html',
  styles: ['.table tr.active td {   background-color:#123456 !important;    color: white;  }'],
})
export class Servicestatisticdatausage3Component implements OnInit {
  ...
  makeformarray(data: any) {
    ...
    for (let boxIndex = 0; boxIndex < this.datalist.length; boxIndex++) {
      ...
      console.log((<FormArray>this.datausage3.controls["_datausage"]));
    }
...
this.loading=false;
  ...
  deleteseletedsitefromcategory(item:any) {
